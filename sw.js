const C='stable-quizball-v5-logo-sos-lines';
const A=["./","index.html","style.css?v=stable5","app.js?v=stable5","manifest.json","icon.svg","assets/library.json","assets/gaming-background.svg","find-the-flags.html","assets/flags-world.webp","assets/flags-world.json","assets/quotes-sprite.webp","assets/teams-sprite.webp","assets/players-sprite.webp"];
