const C='retrogames-dlemonis-v24-repaired-1';
const A=['./','index.html','style.css?v=241','app.js?v=241','manifest.json','icon.svg','assets/library.json','assets/gaming-background.svg','find-the-flags.html','assets/flags-world.webp','assets/flags-world.json'];
